                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            var dep = obituary.dep == 1 ? 'DESCANSA EN PAZ' : ''
                            var styleDep = {
                            ...
                            setTimeout(() => {
                                ...
                                setTimeout(() => {
                                    ...
                                    var optionsLogo = {
                                        ...
                                        draggable: true,
                                        name: 'image',
                                        src: uri + 'core/libraries/pdfs/images/cruz_black.jpg',
                                        mouse: true,
                                        rotation: null,
                                        scaleX:  0.75,
                                        scaleY: 0.785,
                                                            ...
                                                            setTimeout(() => {
                                                                ...
                                                                setTimeout(() => {
                                                                    ...
                                                                    switch(obituaryType){
                                                                        ...
                                                                        case '5':
                                                                            //ORACION - CUERPO
                                                                            oracion8 = "Servicios Funerarios Ntra. Sra. del Prado S.L."
                                                                            oracion8X = 432.42
                                                                            oracion8Y = 524
                                                                            oracion8Width = 343.57
                                                                            ...
                                                                            switch(obituaryType){
                                                                                ...
                                                                                case '1':
                                                                                    var PrayDeceasedX = 0.5,
                                                                                        ...
                                                                                        PrayDeceasedText = "RUEGAN una oración por su alma";
