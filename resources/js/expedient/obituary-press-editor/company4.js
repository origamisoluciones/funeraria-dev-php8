    ...
    if(!loadFlag){
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                // Textos
                // Datos de contacto
                var text = 'FUNERARIA GARRIDO - QUIROGA - SAN CLODIO - CAUREL\nTLF. OFIC. 24 H.: 982. 42 84 53\nFacebook: Tanatorio Funeraria Garrido - Envío de pésames: www.funerariagarrido.es'
                var x = 52
                var y = 985
                var fill = '#000000'
                                    ...
                                    setTimeout(() => {
                                        ...
                                        $.each(auxText, function(index, elem){
                                            if(index == auxText.length - 2){
                                                diedText += elem + ',\n'
                                            }else if(index == auxText.length - 3){
                                                diedText += elem + ','
                                            }else{
                                                diedText += elem 
                                            }
