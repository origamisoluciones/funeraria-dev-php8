    ...
    if(!loadFlag){
        setTimeout(() => {
            ...
            var optionsTransept = {
                ...
                draggable: true,
                name: 'image',
                src: uri + 'resources/files/' + company + '/expedients/' + expedientID + '/obituary-press/' + obituaryType + '/' + obituaryModel + '/img/transept.png',
                mouse: true,
                rotation: null,
                                                            ...
                                                            setTimeout(() => {
                                                                ...
                                                                setTimeout(() => {
                                                                    ...
                                                                    var optionsLogo = {
                                                                        ...
                                                                        draggable: true,
                                                                        name: 'image',
                                                                        src: uri + 'resources/files/' + company + '/expedients/' + expedientID + '/obituary-press/' + obituaryType + '/' + obituaryModel + '/img/qrwhatsapp.png',
                                                                        mouse: true,
                                                                        rotation: null,
