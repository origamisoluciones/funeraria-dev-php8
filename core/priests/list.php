<?php
    ...
    */
    ...
    // indexes
    $columns = array(
        array('db' => 'Priests.priestID', 'dt' => 0),
        array('db' => 'Priests.name', 'dt' => 1),
        array('db' => 'Locations.name', 'dt' => 2),
        array('db' => 'Priests.area', 'dt' => 3),
        array('db' => 'Priests.parish', 'dt' => 4),
        array('db' => 'Priests.homePhone', 'dt' => 5),
        array('db' => 'Priests.mobilePhone', 'dt' => 6),
        array('db' => 'Priests.otherPhone', 'dt' => 7)
    );
    ...
    $whereOn = array("Priests.location = Locations.locationID");
    $where = "Priests.leavingDate IS NULL";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Configuración", "Curas - Consulta", "'Ha consultado los curas'");
?>