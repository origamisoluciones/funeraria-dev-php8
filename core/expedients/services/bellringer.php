<?php
    ...
    */
    ...
    // DB table to use
    $table = array('BellRingers', 'Services_Bellringers');
    ...
    // indexes
    $columns = array(
        array('db' => 'Services_Bellringers.ID', 'dt' => 0),
        array('db' => 'BellRingers.name', 'dt' => 1),
        array('db' => 'BellRingers.parish', 'dt' => 2),
        array('db' => 'BellRingers.mobilePhone', 'dt' => 3),
        array('db' => 'Services_Bellringers.notified', 'dt' => 4)
    );
    ...
    $where = "Services_Bellringers.bellringer = BellRingers.ID AND Services_Bellringers.service = " . $_GET['ID'];
