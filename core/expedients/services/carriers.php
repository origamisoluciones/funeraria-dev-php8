<?php
    ...
    */
    ...
    // DB table to use
    $table = array('Services_Carriers', 'Carriers');
    
    // Table's primary key
    $primaryKey = 'Services_Carriers.ID';
    ...
    // indexes
    $columns = array(
        array('db' => 'Services_Carriers.ID', 'dt' => 0),
        array('db' => 'CONCAT(Carriers.name, " ", Carriers.surname)', 'dt' => 1),
        array('db' => 'Carriers.phones', 'dt' => 2),
        array('db' => 'Services_Carriers.confirmed', 'dt' => 3)
    );
    ...
    $where = "Services_Carriers.carrier = Carriers.carrierID AND Services_Carriers.service = " . $_GET['ID'];
