<?php
    ...
    */
    ...
    // DB table to use
    $table = array('Choirs', 'Services_Choirs');
    ...
    // indexes
    $columns = array(
        array('db' => 'Services_Choirs.ID', 'dt' => 0),
        array('db' => 'Choirs.name', 'dt' => 1),
        array('db' => 'Choirs.address', 'dt' => 2),
        array('db' => 'Choirs.homePhone', 'dt' => 3),
        array('db' => 'Choirs.mobilePhone', 'dt' => 4),
        array('db' => 'Choirs.otherPhone', 'dt' => 5),
        array('db' => 'Services_Choirs.notified', 'dt' => 6)
    );
    ...
    $where = "Services_Choirs.choir = Choirs.choirID AND Services_Choirs.service = " . $_GET['ID'];
