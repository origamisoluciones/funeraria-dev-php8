<?php
    ...
    if(empty($_GET) || !isset($_GET['expedient']) || !isset($_GET['docType'])){
    ...
    */
    ...
    // Where condition
    $where = "Expedients_Documents.type = " . $_GET['docType'] . " AND
              Expedients_Documents.expedient = " . $_GET['expedient'] . " AND
              Expedients_Documents.nameFile != ''";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createExpedient("Expedients", $_GET['expedient'], "Expendientes - Documentación - Lista", "'Ha listado la documentación del expediente'");*/
?>