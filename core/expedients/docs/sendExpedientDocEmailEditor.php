<?php 
    ...
    $docEditorId = cleanStr($_POST['docEditorId']);

    // Checks if exists file
    if(!file_exists($_SESSION['basePath'] . "resources/files/{$_SESSION['company']}/expedients/$expedient/documentsEditor/$docEditorId/files/documento.pdf")){
    ...
    // Save file version
    if(!is_dir($_SESSION['basePath'] . "resources/files/{$_SESSION['company']}/expedients/$expedient/documentsEditor/history_sent/$historyID")){
        mkdir($_SESSION['basePath'] . "resources/files/{$_SESSION['company']}/expedients/$expedient/documentsEditor/history_sent/$historyID", 0777, true);
    }
    copy(
        $_SESSION['basePath'] . "resources/files/{$_SESSION['company']}/expedients/$expedient/documentsEditor/$docEditorId/files/documento.pdf", 
        $_SESSION['basePath'] . "resources/files/{$_SESSION['company']}/expedients/$expedient/documentsEditor/history_sent/$historyID/$fileName"
    );

    $docEditorPath = $_SESSION['basePath'] . "resources/files/{$_SESSION['company']}/expedients/$expedient/documentsEditor/$docEditorId/files/documento.pdf";
    ...
    if($assistantsList != null && $assistantsList != '' && count($assistantsList) > 0){
        ...
        foreach($assistantsList as $index=>$assistant){
            ...
            if($mailHandler->sendExpedientDoc($elemEmail, $expedient, $doc, $fileName, $withCopy, $docEditorPath)){
