<?php
    ...
    */
    ...
    // Where condition
    $where = "Expedients_Documents.type IN (1, 2, 53, 56, 58) AND Expedients_Documents.type > 0 AND Expedients_Documents.expedient = " . $_GET['expedient'];
    ...
    */
    ...
    $logs = new Logs;
    $logs->createExpedient("Expedientes", $_GET['expedient'], "Expendientes - Documentación - Lista", "'Ha listado la documentación del expediente'");*/
?>