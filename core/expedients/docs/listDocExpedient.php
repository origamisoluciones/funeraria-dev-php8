<?php
    ...
    */
    ...
    $where = "Expedients_Documents.type NOT IN(1,2,53,19,20,27,34,35,36,37,38,44,42,45,52,55,54,46,49,50,5,47,51,13,14,15,48,41,56,57,63,64,66$whereAux) AND Expedients_Documents.type != 0 AND Expedients_Documents.expedient = " . $_GET['expedient'] . " AND Expedients_Documents.file NOT LIKE '%justificanteSepelio_%'";
