<?php
    ...
    if(isset($_POST) && isset($_POST['expedient']) && isset($_POST['type']) && isset($_POST['model']) && isset($_POST['stamp'])){
        ...
        $folder = scandir("{$_SESSION['basePath']}/resources/files/{$_SESSION['company']}/expedients/$expedient/reminder-packet-cross/$type/$model/img");
        $files = array();
        $cont = 0;
        ...
        $filesTmp = "{$_SESSION['basePath']}/resources/files/{$_SESSION['company']}/tmp/$expedient";
        if(is_dir($filesTmp)){
