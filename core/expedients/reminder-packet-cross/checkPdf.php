<?php
    ...
    if(isset($_POST) && isset($_POST['expedient']) && isset($_POST['type']) && isset($_POST['model'])){
        ...
        if(file_exists($_SESSION['basePath'] . "resources/files/{$_SESSION['company']}/expedients/$expedient/reminder-packet-cross/$type/$model/files/recordatorio-sobre-cruz.pdf")){
