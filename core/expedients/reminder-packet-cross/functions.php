<?php
    ...
    function createPdfObituary($svg, $expedientID, $obituaryModel, $obituaryType){
        ...
        $svgPath = $_SESSION['basePath'].'resources/files/' . $_SESSION['company'] . '/expedients/'.$expedientID.'/reminder-packet-cross/'.$obituaryModel.$obituaryType.'.svg';
        ...
        $im->writeImage($_SESSION['basePath'].'resources/files/' . $_SESSION['company'] . '/expedients/'.$expedientID.'/reminder-packet-cross/'.$obituaryModel.$obituaryType.'.png');/*(or .jpg)*/
        $im->clear();
        $im->destroy();
    }
?>