<?php
    ...
    function saveObituary($obituary){
        ...
        return $expedients->saveReminder($data);
    }
    ...
    function createPdfObituary($svg, $expedientID, $obituaryModel, $obituaryType){
        ...
        $svgPath = $_SESSION['basePath'].'resources/files/' . $_SESSION['company'] . '/expedients/'.$expedientID.'/reminder/'.$obituaryModel.$obituaryType.'.svg';
        ...
        $im->writeImage($_SESSION['basePath'].'resources/files/' . $_SESSION['company'] . '/expedients/'.$expedientID.'/reminder/'.$obituaryModel.$obituaryType.'.png');/*(or .jpg)*/
        $im->clear();
        $im->destroy();
        ...
        //$html='<img src="'. $svgPath .'">';
        //$pdf->SetHTMLHeader('<img style="width:100%;height:auto;" src="'. $svgPath .'"/>');
        /*$html=$svg;
        
        $pdfPath = $_SESSION['basePath'].'resources/files/expedients/'.$expedientID.'/reminder/'.$obituaryModel.$obituaryType.'.pdf';
        ...
        //Por último tras generar el pdf se elimina el fichero svg temporal utilizado en el proceso
        //unlink($svgPath);
    }
    ?>