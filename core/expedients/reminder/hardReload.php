<?php
    ...
    if(is_dir($_SESSION['basePath'] . 'resources/files/' . $_SESSION['company'] . '/expedients/' . $data['expedient'] . '/reminder/' . $data['type'])){
        rrmdir($_SESSION['basePath'] . 'resources/files/' . $_SESSION['company'] . '/expedients/' . $data['expedient'] . '/reminder/' . $data['type']);
    }
