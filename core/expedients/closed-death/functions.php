<?php
    ...
    function createPdfObituary($svg, $expedientID, $obituaryModel, $obituaryType){
        ...
        $svgPath = $_SESSION['basePath'].'resources/files/' . $_SESSION['company'] . '/expedients/'.$expedientID.'/closed-death/'.$obituaryModel.$obituaryType.'.svg';
        ...
        $im->writeImage($_SESSION['basePath'].'resources/files/' . $_SESSION['company'] . '/expedients/'.$expedientID.'/closed-death/'.$obituaryModel.$obituaryType.'.png');/*(or .jpg)*/
        $im->clear();
        $im->destroy();
    }
    ?>