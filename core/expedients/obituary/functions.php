<?php
    ...
    if(isset($_POST['type'])){
        ...
        switch($type){
            ...
            break;
            case 'getSavedObituaryInit':
                echo json_encode(getSavedObituaryInit($_POST['expedient']));
            break;
            case 'saveObituary':
    ...
    function getSelectedObituary($expedient){
        $expedients = new Expedients();
        return $expedients->getSelectedObituary($expedient);
    }
     ...
     * @return bool
     */
    function getSavedObituaryInit($expedient){
        $expedients = new Expedients();
        return $expedients->getSavedObituaryInit($expedient);
    }
    ...
    function createPdfObituary($svg, $expedientID, $obituaryModel, $obituaryType){
        ...
        $svgPath = $_SESSION['basePath'].'resources/files/' . $_SESSION['company'] . '/expedients/'.$expedientID.'/obituary/'.$obituaryModel.$obituaryType.'.svg';
        ...
        $im->writeImage($_SESSION['basePath'].'resources/files/' . $_SESSION['company'] . '/expedients/'.$expedientID.'/obituary/'.$obituaryModel.$obituaryType.'.png');/*(or .jpg)*/
        $im->clear();
        $im->destroy();
    }
?>