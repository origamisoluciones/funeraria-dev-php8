    ...
    if(isset($_POST) && isset($_POST['expedient']) && isset($_POST['type']) && isset($_POST['model'])){
        ...
        if(!is_dir($_SESSION['basePath'] . 'resources/files/' . $_SESSION['company'] . '/expedients/' . $expedient . '/obituary-press/' . $type . '/' . $model . '/img')){
            ...
            foreach($files as $file){
                if($file != '.' && $file != '..'){
                    copy($_SESSION['basePath'] . 'resources/files/' . $_SESSION['company'] . '/obituaries/' . $model . '/' . $file, $_SESSION['basePath'] . 'resources/files/' . $_SESSION['company'] . '/expedients/' . $expedient . '/obituary-press/' . $type . '/' . $model . '/img/' . $file);
                }
            }

            $file = fopen($_SESSION['basePath'] . 'resources/files/' . $_SESSION['company'] . '/expedients/' . $expedient . '/obituary-press/' . $type . '/' . $model . '/img/.htaccess', 'w');
