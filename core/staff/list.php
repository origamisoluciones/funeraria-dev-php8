<?php
    ...
    */
    ...
    // indexes
    $columns = array(
        array('db' => 'Staff.ID', 'dt' => 0),
        array('db' => 'Staff.code', 'dt' => 1),
        array('db' => 'Staff.name', 'dt' => 2),
        array('db' => 'Staff.surname', 'dt' => 3),
        array('db' => 'Staff.nif', 'dt' => 4),
        array('db' => 'Locations.name', 'dt' => 5),
        array('db' => 'Staff.email', 'dt' => 6),
        array('db' => 'Staff.phones', 'dt' => 7),
        array('db' => 'Staff.extension', 'dt' => 8)
    );
    ...
    // Where condition
    $whereOn = array("Staff.location = Locations.locationID");
    $where = "Staff.leavingDate IS NULL";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Configuración", "Personal - Consulta", "'Ha consultado el personal'");
?>