<?php
    ...
    */
    ...
    // indexes
    $columns = array(
        array('db' => 'Shipper.ID', 'dt' => 0),
        array('db' => 'Shipper.name', 'dt' => 1)        
    );
    ...
    $where = "Shipper.leavingDate IS NULL";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Configuración", "Gestión Económica - Expedidor - Consulta", "'Ha consultado los expedidores'");
?>