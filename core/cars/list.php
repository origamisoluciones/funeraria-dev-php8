<?php
    ...
    */
    ...
    // indexes
    $columns = array(
        array('db' => 'Cars.carID', 'dt' => 0),
        array('db' => 'Cars.name', 'dt' => 1),
        array('db' => 'Cars.brand', 'dt' => 2),
        array('db' => 'Cars.model', 'dt' => 3),
        array('db' => 'Cars.isForService', 'dt' => 4)
    );
    ...
    $where = "Cars.leavingDate IS NULL";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Taller", "Vehículos - Consulta", "'Ha consultado los vehículos'");
?>