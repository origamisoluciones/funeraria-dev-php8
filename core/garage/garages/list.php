<?php
    ...
    // indexes
    $columns = array(
        array('db' => 'Garages.ID', 'dt' => 0),
        array('db' => 'Garages.name', 'dt' => 1),
        array('db' => 'Garages.address', 'dt' => 2),
        array('db' => 'Locations.name', 'dt' => 3),
        array('db' => 'Garages.mail', 'dt' => 4),
        array('db' => 'Garages.phone', 'dt' => 5)
    );
    ...
    $whereOn = array("Garages.location = Locations.locationID");
    $where = "Garages.leavingDate IS NULL";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Taller", "Taller - Consulta", "'Ha consulta los talleres'");
?>