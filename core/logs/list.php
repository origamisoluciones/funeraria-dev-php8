<?php
    ...
    */
    ...
    $columns = array(
        ...
        array('db' => 'Logs.category', 'dt' => 2),
        array('db' => 'Logs.action', 'dt' => 3),
        array('db' => 'Logs.description', 'dt' => 4)
    );
    ...
    // Where condition
    $where = array("Logs.user = Users.userID");
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Logs", "Consulta", "'Ha consultado el registro de logs'");
?>