<?php
    ...
    */
    ...
    $where = array("Assistances.expedient = Expedients.expedientID AND Assistances.leavingDate IS NULL");
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Asistencias", "Consulta", "'Ha consultado las asistencias'");
?>