<?php
    ...
    */
    ...
    // indexes
    $columns = array(
        array('db' => 'Prices.priceID', 'dt' => 0),
        array('db' => 'Prices.name', 'dt' => 1),
        array('db' => 'Prices.year', 'dt' => 2)
    );
    ...
    $where = "Prices.leavingDate IS NULL AND year = " . date('Y');
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Configuración", "Tarifas - Consulta", "'Ha consultado las tarifas'");
?>