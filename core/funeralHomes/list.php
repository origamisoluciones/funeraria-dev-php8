<?php
    ...
    */
    ...
    // Table's primary key
    $primaryKey = 'FuneralHomes.funeralHomeID';
    ...
    // indexes
    $columns = array(
        array('db' => 'FuneralHomes.funeralHomeID', 'dt' => 0),
        array('db' => 'FuneralHomes.nif', 'dt' => 1),
        array('db' => 'FuneralHomes.name', 'dt' => 2),
        array('db' => 'FuneralHomes.mail', 'dt' => 3),
        array('db' => 'FuneralHomes.phones', 'dt' => 4),
    ...
    // Where condition
    $whereOn = array("FuneralHomes.location = Locations.locationID");
    $where = "FuneralHomes.leavingDate IS NULL";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Configuración", "Funerarias - Consulta", "'Ha consultado las funerarias'");
?>