<?php
    ...
    */
    ...
    // indexes
    $columns = array(
        array('db' => 'Emails.ID', 'dt' => 0),
        array('db' => 'Emails.email', 'dt' => 1)
    );
    ...
    $where = "Emails.leavingDate IS NULL AND Emails.type = 0";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Configuración", "Correos - Consulta", "'Ha consultado los correos'");
?>