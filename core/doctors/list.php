<?php
    ...
    */
    ...
    // indexes
    $columns = array(
        array('db' => 'Doctors.ID', 'dt' => 0),
        array('db' => 'Doctors.name', 'dt' => 1),
        array('db' => 'Doctors.college', 'dt' => 2)
    );
    ...
    $where = "Doctors.leavingDate IS NULL";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Configuración", "Médicos - Consulta", "'Ha consultado los médicos'");
?>