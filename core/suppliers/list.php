<?php
    ...
    */
    ...
    // Table's primary key
    $primaryKey = 'Suppliers.supplierID';
    ...
    // indexes
    $columns = array(
        array('db' => 'Suppliers.supplierID', 'dt' => 0),
        array('db' => 'Suppliers.nif', 'dt' => 1),
        array('db' => 'Suppliers.name', 'dt' => 2),
        array('db' => 'Suppliers.phones', 'dt' => 3),
        array('db' => 'Suppliers.mail', 'dt' => 4)
    );
    ...
    $where = "Suppliers.leavingDate IS NULL AND Suppliers.name != 'No proveedor'";
    ...
    */
    ...
    $logs = new Logs;
    $logs->createSimple("Configuración", "Proveedores - Consulta", "'Ha consultado los proveedores'");
?>