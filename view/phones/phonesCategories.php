<?php
    ...
    isset($_SESSION['basePath']) ?: $_SESSION['basePath'] = $_SERVER['DOCUMENT_ROOT'] . "/";
...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Categorías de teléfonos</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed page phones-categories-page">
        <?php require_once($_SESSION['basePath'] . "view/phones/phonesCategories-modal.php"); ?>
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo $utils->getRoute(); ?>telefonos">Teléfonos</a></li>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-phone" aria-hidden="true"></i> Gestión de Categorías de Teléfonos</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-phoneCategory"><i class="fa fa-plus" aria-hidden="true"></i> NUEVA CATEGORÍA</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/phones/categories/functions.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>