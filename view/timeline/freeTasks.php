...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Tareas libres</title>
...
<body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed timeline-scheduled-tasks">
    <?php require_once($_SESSION['basePath'] . "view/timeline/modal/freeTasks.php"); ?>
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Tareas Libres</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                    <h3 class="box-title"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>Gestión de Tareas Libres</h3>
                                </div>
                                <div class="pull-right">
                                    <div class="box-actions">
                                        <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-task"><i class="fa fa-plus" aria-hidden="true"></i> NUEVA TAREA</a>
                                    </div>
                                </div>
                            </div>
                            <div class="box-body">
    ...
    <script src="<?php echo $utils->getRoute(); ?>resources/js/timeline/freeTasks.js?v=<?=CACHE_DATE?>"></script>
</body>
</html>