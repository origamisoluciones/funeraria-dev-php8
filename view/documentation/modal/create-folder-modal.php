<div class="modal fade" id="modal-create-folder" role="dialog" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Crear carpeta</span></h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" id="saveFolder" class="btn btn-sm btn-primary"><i class="fa fa-cloud-upload" aria-hidden="true"></i> CREAR CARPETA</button>       
