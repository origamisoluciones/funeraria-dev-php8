...
<html>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed pendingLiterales-page service-control-page page">
        <?php require_once($_SESSION['basePath'] . "view/tutorials/modal/show-tutorial-modal.php"); ?>
        <div class="wrapper">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body" id="box-body">
                                    <div class="table-responsive">
                                        <table id="tutorials" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>          
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/tutorials/list.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>