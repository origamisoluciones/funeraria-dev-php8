...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Libro registro de personal</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed personalRecords-page page">
        <div class="wrapper">
            <?php require_once($_SESSION['basePath'] . "resources/themes/adminlte/header.php"); ?>
            <?php require_once($_SESSION['basePath'] . "resources/themes/adminlte/main-sidebar.php"); ?>
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Libro registro de personal</h1>
                                    ...
                                    <form class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control datepicker" id="fromDate" name="fromDate" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control datepicker" id="toDate" name="toDate" autocomplete="off">
                                            </div>
                                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/books/personalRecords/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>