...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Libro registro de funerarias</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed funeraryRecords-page page">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Libro registro de funerarias</h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Libro de registro de funerarias</li>
                    </ol>
                </section>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/books/funeraryRecords/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>