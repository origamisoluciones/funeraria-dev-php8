...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Libro registro de tanatorio</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed funeraryRecords-page page">
            ...
            <?php require_once($_SESSION['basePath'] . "resources/themes/adminlte/main-sidebar.php"); ?>
                <div class="content-wrapper">
                    <section class="content-header">
                        <h1>Libro registro de tanatorio</h1>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Libro de registro de tanatorio</li>
                        </ol>
                    </section>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/books/mortuaryRecords/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>