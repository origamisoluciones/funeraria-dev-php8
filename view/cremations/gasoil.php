...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Gasoil</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed gasoil-p gasoil-page page">
        <?php require_once($_SESSION['basePath'] . "view/cremations/modal/gasoil-new-modal.php"); ?>
        <?php require_once($_SESSION['basePath'] . "view/cremations/modal/gasoil-edit-modal.php"); ?>
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-tachometer" aria-hidden="true"></i> Gestión de Gasoil</h3>                   
                                    </div>
                                    ...
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a class="btn btn-primary btn-sm btn-new" id="goNewGasoil"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO GASOIL</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/cremations/gasoil.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>