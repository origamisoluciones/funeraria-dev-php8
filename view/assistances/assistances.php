...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Asistencias</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed assistances-page assistances-main-page page">
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-plus-circle" aria-hidden="true"></i> Gestión de Asistencias</h3>
                                    </div>
                                ...
                                <div class="box-body" id="box-body">
                                    <div class="table-responsive">
                                        <table id="assistances" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>          
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/assistances/assistances/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>