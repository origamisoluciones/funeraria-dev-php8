...
<body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed statistics-page assistances-page">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <div class="pull-left">
                                <h3 class="box-title"><i class="fa fa-pie-chart"></i> Estadísticas de edad media</h3>                   
                            </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="table-responsive clearfix" id="age" > <!--style="height: 600px; overflow: scroll;"-->
                                <table class="table table-striped table-bordered text-center" id="ageTable" width="100%" cellspacing="0">
                                    <thead id="ageHead">
                                        <tr class="text-center">
                                            <th>Cliente</th>
                                            <th class="men-section">Edad Media Hombres</th>
                                            <th class="men-section" colspan="2">Estado Civil Hombres</th>
                                            <th class="women-section">Edad Media Mujeres</th>
                                            <th class="women-section" colspan="2">Estado Civil Mujeres</th>                                                                               
                                        </tr>
                                    </thead>
                                    <tbody id="ageBody">
                                        <tr>
    ...
    <script src="<?php echo $utils->getRoute(); ?>resources/js/statistics/age/functions.js?v=<?= CACHE_DATE ?>"></script>
</body>
</html>