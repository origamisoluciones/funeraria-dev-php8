...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $utils->getRoute();?>resources/themes/admingilte/plugins/datatables/dataTables.bootstrap.css?v=<?= CACHE_DATE ?>">
...
<body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed statistics-page assistances-page">
    <div class="wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Estadísticas</li>
                <li class="active">Control de Emisiones</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <div class="pull-left">
                                <h3 class="box-title"><i class="fa fa-pie-chart"></i> Estadísticas de Control de Emisiones</h3>                   
                            </div>
                        </div>
                        <div class="box-body">
                            <fieldset>
                                ...
                                <div class="row" style="margin-bottom: 15px;">
                                    <div class="col-xs-12">
                                        ...
                                        <div id="error" class="input-group pull-left" style="color:red;margin-left: 0.5em;"></div>

                                        <div class="input-group pull-left" style="margin-left:1em">
                                            <div class="input-group-addon small">ESCALA BACHARACH</div>
                                            <select id="bacharachScale" name="bacharachScale" class="form-control">
                                        ...
                                        <div class="input-group pull-left" style="margin-left:1em">
                                            <button type="button" id="search" class="btn btn-primary"><i class="fa fa-search"></i> BUSCAR</button>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
    ...
    <script src="<?php echo $utils->getRoute(); ?>resources/js/statistics/emissionControl/functions.js?v=<?= CACHE_DATE ?>"></script>
</body>
</html>