...
<body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed statistics-page assistances-page">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>Estadísticas</li>
                    <li class="active">Uso de tanatorios</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                    <h3 class="box-title"><i class="fa fa-pie-chart"></i> Estadísticas de uso de tanatorios</h3>                   
                                </div>
                            ...
                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-10">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" size="12" class="datepicker form-control" id="stayDateSince" autocomplete="off" disabled>
                                                            <div class="input-group-addon small">Hasta</div>
                                                            <input type="text" size="12" class="datepicker form-control" id="stayDateUntil" autocomplete="off" disabled>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-10">
                                                        <div class="input-group bootstrap-timepicker timepicker">
                                                            <div class="input-group-addon small">Desde</div>
                                                            <input type="text" size="12" class="time form-control" id="stayTimeSince" autocomplete="off" disabled>
                                                            <div class="input-group-addon small">Hasta</div>
                                                            <input type="text" size="12" class="time form-control" id="stayTimeUntil" autocomplete="off" disabled>
                                                        </div>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-10">
                                                        <div class="input-group">
                                                            <div class="input-group-addon small">Desde</div>
                                                            <input type="text" size="12" class="datepicker form-control" id="dateParticularSince" autocomplete="off" disabled>
                                                            <div class="input-group-addon small">Hasta</div>
                                                            <input type="text" size="12" class="datepicker form-control" id="dateParticularUntil" autocomplete="off" disabled>
                                                        </div>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-10">
                                                        <div class="input-group">
                                                            <div class="input-group-addon small">Desde</div>
                                                            <input type="text" size="12" class="datepicker form-control" id="dateSeguroSince" autocomplete="off" disabled>
                                                            <div class="input-group-addon small">Hasta</div>
                                                            <input type="text" size="12" class="datepicker form-control" id="dateSeguroUntil" autocomplete="off" disabled>
                                                        </div>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-10">
                                                        <div class="input-group">
                                                            <div class="input-group-addon small">Desde</div>
                                                            <input type="text" size="12" class="datepicker form-control" id="dateEmpresaSince" autocomplete="off" disabled>
                                                            <div class="input-group-addon small">Hasta</div>
                                                            <input type="text" size="12" class="datepicker form-control" id="dateEmpresaUntil" autocomplete="off" disabled>
                                                        </div>
                                ...
                                <div class="table-responsive clearfix" id="mortuary">
                                    <table class="table table-striped table-bordered text-center" id="mortuaryUseTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr class="text-center">
                                                <td>Tanatorio</td>
                                                <td>Total Servicios</td>
                                                <td>Día/s con más concurrencia de salas</td>
                                                <td>Nº sala</td>
                                                <td>Nº servicios por sala</td>
                                                <td>Precio medio sala</td>                                                                            
                                            </tr>
                                        </thead>
                                        <tbody id="mortuaryUseBody">
                                            <tr>
                                                <td colspan="13">
    ...
    <script src="<?php echo $utils->getRoute(); ?>resources/js/statistics/mortuaryUse/functions.js?v=<?= CACHE_DATE ?>"></script>
</body>
</html>