...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Control de visitas</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed visitscontrol-page page">
        <?php require_once($_SESSION['basePath'] . "view/visitsControl/modal/modal-change-state.php"); ?>
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Mantenimiento</li>
                        <li class="active">Control de visitas</li>
                    </ol>
                </section>
                <input type="hidden" id="visitControlID" value="<?php echo $visitControl; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                    <h3 class="box-title">Control de visitas</h3>
                                </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/visitsControl/visitsControl/functions.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>