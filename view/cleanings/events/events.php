...
<html>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed events-cleanings-page page">
        <?php require_once($_SESSION['basePath'] . "view/cleanings/events/modal/event-modal.php"); ?>
        <?php require_once($_SESSION['basePath'] . "view/cleanings/events/modal/new-event-modal.php"); ?>
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Mantenimiento</li>
                        <li class="active">Agenda de Mantenimiento</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"><i class="fa fa-wrench" aria-hidden="true"></i> Agenda de Mantenimiento</h3>
                                </div>
                                <div class="box-body">
                                    <div id="legend">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/cleanings/events/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>