...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Resumen Limpieza Coches</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed cars-cleanings-page page">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Mantenimiento</li>
                        <li class="active">Resumen limpieza coches</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="col-xs-4">
                                        <h3 class="box-title"><i class="fa fa-wrench" aria-hidden="true"></i> Resumen limpieza de coches</h3>
                                    </div>
                                    <div class="col-xs-8">
                                        ...
                                        <div class="box-filters pull-right">
                                            <form class="form-inline">
                                                ...
                                                <button id="search" name="search" type="button" class="btn btn-primary"><i class="fa fa-search" aria-hidden="true"></i> Buscar</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="cleaningCarsTable" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/cleanings/cars/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>