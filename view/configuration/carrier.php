...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Porteadores</title>
...
<body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page carriers-page">
    <?php require_once($_SESSION['basePath'] . "view/configuration/modal/carrier-modal.php"); ?>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Porteadores</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                    <h3 class="box-title"><i class="fa fa-user" aria-hidden="true"></i> Gestión de Porteadores</h3>
                                </div>
                                <div class="pull-right">
                                    <div class="box-actions">
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-carrier"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                    </div>
                                </div>
                            </div>
                            <div class="box-header">
    ...
    <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/carrier/functions.js?v=<?=CACHE_DATE?>"></script>
</body>
</html>