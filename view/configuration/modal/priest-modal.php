                        ...
                        <div class="col-xs-9">
                            <div class="input-group">
                                ...
                                <span class="input-group-addon">
                                    <a href="#" class="btn-add-church" modal="formNewData" title="Añadir iglesia">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="formEditData" name="formEditData">
                    <div id="msg"></div>
                    <input type="hidden" id="priestID" name="priestID" value="">
                    <div class="form-group">
                        <label for="name" class="col-xs-3 control-label">Nombre</label>
                        <div class="col-xs-9">
                            <input type="text" size="30" class="form-control" id="name" name="name" autocomplete="none">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <div class="input-group">
                                <select id="church" name="church" class="form-control church"></select>
                                <span class="input-group-addon">
                                    <a href="#" class="btn-add-church" modal="formEditData" title="Añadir iglesia">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </span>
                            </div>
