            ...
            <div class="modal-body">
                <form class="form-horizontal" id="formNewData" name="formNewData">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" size="30" class="form-control" id="company" name="company" autocomplete="none">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <hr>
                    <div class="form-group hide vivoRecuerdoSectionCreate">
                    ...
                    <div class="form-group hide vivoRecuerdoSectionCreate">
                        ...
                        <div class="col-xs-9">
                            <input type="text" size="50" class="form-control" id="apiClient" name="apiClient" autocomplete="none">
                    ...
                    <div class="form-group hide vivoRecuerdoSectionCreate">
                        ...
                        <div class="col-xs-9">
                            <input type="text" size="50" class="form-control" id="apiKey" name="apiKey" autocomplete="none">
                            <span class="inputError" id="apiKeyError"></span>
                        </div>
                    </div>
                    <div class="form-group hide tellmebyeMortuarySectionCreate">
                        <div class="col-xs-offset-1 col-xs-6">
                            <h4 class="modal-title">Configuración API <span class="bolder">Tellmebye</span></h4>
                        </div>
                    </div>
                    <div class="form-group hide tellmebyeMortuarySectionCreate">
                        <label for="tellmebyeMortuary" class="col-xs-3 control-label">Sucursal</label>
                        <div class="col-xs-9">
                            <select class="form-control mortuary-tellmebye" name="tellmebyeMortuary" id="tellmebyeMortuary"></select>
                        </div>
                    </div>
...
<div class="modal fade" id="modal-edit-mortuary" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Editar <span class="bolder">Tanatorio</span></h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="formEditData" name="formEditData">
                    <input type="hidden" id="mortuaryID" name="mortuaryID" value="">
                    <div class="form-group">
                        <label for="name" class="col-xs-3 control-label">Nombre</label>
                        <div class="col-xs-9">
                            <input type="text" size="30" class="form-control" id="name" name="name" autocomplete="none">
                    ...
                    <div class="form-group">
                        <label for="latitude" class="col-xs-3 control-label">Latitud</label>
                        <div class="col-xs-9">
                            <input type="number" size="30" min="0" class="form-control" id="latitude" name="latitude" autocomplete="none">
                            <span class="inputError" id="latitudeError"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="longitude" class="col-xs-3 control-label">Longitud</label>
                        <div class="col-xs-9">
                            <input type="number" size="30" min="0" class="form-control" id="longitude" name="longitude" autocomplete="none">
                            <span class="inputError" id="longitudeError"></span>
                        </div>
                    </div>
                    <div class="form-group situation-link clearfix">
                    ...
                    <hr>
                    <div class="form-group hide vivoRecuerdoSectionUpdate">
                        <div class="col-xs-offset-1 col-xs-6">
                            <h4 class="modal-title">Configuración API <span class="bolder">Vivo Recuerdo</span></h4>
                        </div>
                    </div>
                    ...
                    <div class="form-group hide tellmebyeMortuarySectionUpdate">
                        <div class="col-xs-offset-1 col-xs-6">
                            <h4 class="modal-title">Configuración API <span class="bolder">Tellmebye</span></h4>
                        </div>
                    </div>
                    <div class="form-group hide tellmebyeMortuarySectionUpdate">
                        <label for="tellmebyeMortuary" class="col-xs-3 control-label">Sucursal de Tellmebye</label>
                        <div class="col-xs-9">
                            <select class="form-control mortuary-tellmebye" name="tellmebyeMortuaryUpdate" id="tellmebyeMortuaryUpdate"></select>
                        </div>
                    </div>
                    <div id="warning-message"></div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i> Cancelar</button>
                        <button id="saveEditMortuary" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
                    </div>
                </form>
            </div>
        </div>
