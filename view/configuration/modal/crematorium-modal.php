...
<div class="modal fade" id="modal-new-crematory" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="formNewData" name="formNewData" action="" method="post">
                    ...
                    <div class="form-group">
                        <label for="company" class="col-xs-3 control-label">Empresa</label>
                        <div class="col-xs-9">
                            <input type="text" size="30" class="form-control" id="company" name="company" autocomplete="none">
                            <span class="inputError" id="companyError"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="saveNewCrematory" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="modal-edit-crematory" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Editar <span class="bolder">Crematorio</span></h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="formEditData" name="formEditData" action="" method="post">
                    <input type="hidden" id="crematoriumID" name="crematoriumID" value="">
                    <div class="form-group">
                        <label for="name" class="col-xs-3 control-label">Nombre</label>
                        <div class="col-xs-9">
                            <input type="text" size="30" class="form-control" id="name" name="name" autocomplete="none">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i> Cancelar</button>
                        <button id="saveEditCrematory" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
                    </div>
                </form>
            </div>
        </div>
