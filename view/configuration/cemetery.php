...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Cementerio</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed cemeteries-page">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Cementerios</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-cemetery fa-small" aria-hidden="true"></i> Gestión de Cementerios</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-cemetery"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-header">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/cemetery/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>