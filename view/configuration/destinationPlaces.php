...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Lugares de destino</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed deceased-in-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/destinationPlaces.php"); ?>
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Lugares de Destino</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"> Gestión de Lugares de Destino Intermedios</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-destinarion-middle"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO LUGAR INTERMEDIO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="datatableMiddle" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"> Gestión de Lugares de Destino Finales</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            <label>
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-destinarion-final"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO LUGAR FINAL</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="datatableFinal" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/destinationPlaces/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>