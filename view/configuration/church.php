...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Iglesias</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed churches-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/church-modal.php"); ?>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-church fa-small" aria-hidden="true"></i> Gestión de Iglesias</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-church"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-header">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/church/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>