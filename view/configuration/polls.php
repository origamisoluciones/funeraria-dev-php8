...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Encuestas de satisfacción</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed survey-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/polls-modal.php"); ?>
        <div class="wrapper">
            <?php require_once($_SESSION['basePath'] . "resources/themes/adminlte/header.php"); ?>
            <?php require_once($_SESSION['basePath'] . "resources/themes/adminlte/main-sidebar.php"); ?>
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Gestión de Encuestas de Satisfacción</h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-list-alt" aria-hidden="true"></i> Gestión de Encuestas de Satisfacción</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-poll"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/polls/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>