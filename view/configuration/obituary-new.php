...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Plantillas de esquelas</title>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Plantillas de Esquela</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa" aria-hidden="true"></i> Gestión de plantillas de esquelas</h3>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <form id="formEditObituaryTemplate" class="form-horizontal">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-xs-8">
                                                <div class="form-group">
                                                    <label for="description" class="col-xs-2 control-label">Descripción</label>
                                                    <div class="col-xs-10">
                                                        <div class="input-group">
                                                            <textarea rows="3" cols="60" class="form-control" id="description" name="description"></textarea>
                                                        </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-xs-4">
                                                <div class="form-group">
                                                    <label for="name" class="col-xs-4 control-label">Imagen difunto</label>
