...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Productos</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed product-page configuration-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/product-modal.php"); ?>
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/product-action-modal.php"); ?>
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-product-hunt" aria-hidden="true"></i> Gestión de Productos</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-product"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO PRODUCTO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-product-hunt" aria-hidden="true"></i> Gestión de Acciones de Producto</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            <label>
                                                Buscar:
                                                <input id="input-search-actions" class="form-control input-sm" aria-controls="datatable2" type="search">
                                            </label>
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-action"><i class="fa fa-plus" aria-hidden="true"></i> NUEVA ACCIÓN</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="datatableActions" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/product/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>