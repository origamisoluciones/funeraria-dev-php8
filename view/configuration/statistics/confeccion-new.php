...
<html>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page literal-new-page">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Panel de Nueva Plantilla de Confecciones</h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Nueva plantilla de confecciones</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-pie-chart"></i> Nueva plantilla de Confecciones</h3>                   
                                    </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/statistics/making/new/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>