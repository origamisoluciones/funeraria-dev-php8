...
<html>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page literal-new-page">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Panel de Editar Plantilla de Estadísticas Generales</h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Editar plantilla de estadísticas generales</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-pie-chart"></i> Editar plantilla de Estadísticas Generales</h3>                   
                                    </div>
                                </div>
                                <div class="box-body">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/statistics/general/edit/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>