...
<html>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page literal-new-page">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Panel de Editar Plantilla de Confecciones</h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Editar plantilla de confecciones</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-pie-chart"></i> Modificar plantilla de confecciones</h3>                   
                                    </div>
                                        ...
                                        <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="input-group date">
                                                                ...
                                                                <input type="text" size="12" class="datepicker form-control" id="requestDate" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-11">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" size="12" class="datepicker form-control" id="requestDateSince" disabled>
                                                                <div class="input-group-addon small">Hasta</div>
                                                                <input type="text" size="12" class="datepicker form-control" id="requestDateUntil" disabled>
                                                            </div>
                                            ...
                                            <div class="row spaceBottom">
                                                <div class="col-xs-4">
                                                    <div class="form-group">
                                                        <label class="control-label col-xs-6">
                                                            <input type="checkbox" id="expedientTypesCheck">
                                                            Tipo de expedient
                                                        </label>
                                                        <div class="col-xs-6">
                                                            <select class="form-control" id="expedientTypes" multiple disabled></select>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="input-group date">
                                                                ...
                                                                <input type="text" size="12" class="datepicker form-control" id="birthdate" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xs-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-11">
                                                            <div class="input-group">
                                                                <div class="input-group-addon small">Desde</div>
                                                                <input type="text" size="12" class="datepicker form-control" id="birthdateSince" disabled>
                                                                <div class="input-group-addon small">Hasta</div>
                                                                <input type="text" size="12" class="datepicker form-control" id="birthdateUntil" disabled>
                                                            </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/statistics/making/edit/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>