...
<html>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page times-new-page">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Panel de Nueva Plantilla de Tiempos de Respuesta</h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Nueva plantilla de tiempos de respuesta</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"><i class="fa fa-pie-chart fa-small" aria-hidden="true"></i> Plantilla para Tiempos de Respuesta</h3>
                                </div>
                                <div class="box-body">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/statistics/times/new/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>