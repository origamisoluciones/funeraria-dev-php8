    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed statistics-page assistances-page">
        <div class="wrapper">
            ...
            <section class="content-header">
                <h1>Panel de Nueva Plantilla de Horarios de Servicios</h1>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Nueva plantilla de horarios de servicios</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                    <h3 class="box-title"><i class="fa fa-pie-chart"></i> Nueva plantilla de Horarios de Servicios</h3>                   
                                </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/statistics/servicesTimes/new/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>