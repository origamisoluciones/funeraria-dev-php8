...
<html>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Panel de Editar Plantilla de Asistencias</h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Editar plantilla de asistencias</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-pie-chart fa-small" aria-hidden="true"></i> Editar Plantilla para Asistencias</h3>
                                    </div>
                                ...
                                <div class="box-body">
                                    <form class="form-horizontal" id="assistances-edit">
                                        <input type="hidden" id="ID" value="<?php echo $id; ?>">
                                        <div class="form-group">
                                            <label for="name" class="col-xs-1 control-label">Nombre</label>
                                            <div class="col-xs-10">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/statistics/assistances/edit/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>