    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed statistics-page assistances-page">
        <div class="wrapper">
            ...
            <section class="content-header">
                <h1>Panel de Nueva Plantilla de Uso de Tanatorios</h1>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Nueva plantilla de uso de tanarios</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                    <h3 class="box-title"><i class="fa fa-pie-chart"></i> Nueva plantilla de Uso de Tanatorios</h3>                   
                                </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources\js\configuration\statistics\mortuaryUse\new\functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>