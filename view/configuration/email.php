...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Correos</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed emails-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/email-modal.php"); ?>
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-at" aria-hidden="true"></i> Gestión de Correos Electrónicos</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            <label>
                                                Buscar:
                                                <input id="input-search-control" class="form-control input-sm" aria-controls="datatable" type="search">
                                            </label>
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-email-control"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="datatableControl" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/email/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>