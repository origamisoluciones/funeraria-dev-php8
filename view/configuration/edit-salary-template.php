...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Editar plantilla de salarios</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Editar plantillas de salarios</h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Editar plantillas de salarios</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form id="formEditSalarieTemplate" class="form-horizontal">
                                    ...
                                    <div class="table-responsive" id="configTableSalaries">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/salaries/update.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>