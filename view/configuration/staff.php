...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Personal</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page staff-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/staff-modal.php"); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                    <h3 class="box-title"><i class="fa fa-bell" aria-hidden="true"></i> Gestión de Personal</h3>
                                </div>
                                <div class="pull-right">
                                    <div class="box-actions">
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm" id="newStaff"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                    </div>
                                </div>
                            </div>
                            <div class="box-header">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/staff/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>