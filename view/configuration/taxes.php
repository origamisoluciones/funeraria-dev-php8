...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Impuestos y tasas</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page taxes-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/tax-modal.php"); ?>
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Impuestos y tasas</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-percent" aria-hidden="true"></i> Impuestos y tasas</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-tax"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/expenses/taxes/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>