...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Preguntas de encuestas de satisfacción</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page staff-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/polls-items-modal.php"); ?>
        <div class="wrapper">
            <?php require_once($_SESSION['basePath'] . "resources/themes/adminlte/header.php"); ?>
            <?php require_once($_SESSION['basePath'] . "resources/themes/adminlte/main-sidebar.php"); ?>
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Gestión de Preguntas de la Encuesta de Satisfacción <span class="poll-title"></span></h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo $utils->getRoute(); ?>configuracion/encuestas-satisfaccion">Encuestas de Satisfacción</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                <h3 class="box-title"><i class="fa fa-question-circle" aria-hidden="true"></i> Preguntas de la Encuesta <span class="poll-title"></span></h3>
                                </div>
                                <div class="pull-right">
                                    <div class="box-actions">
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm" id="newPollItem"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                    </div>
                                </div>
                            </div>
                            <div class="box-body">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/polls/items/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>