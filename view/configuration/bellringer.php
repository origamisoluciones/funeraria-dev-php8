...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Campaneros</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed bellringers-page">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-bell" aria-hidden="true"></i> Gestión de Campaneros</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-bellringer"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-header">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/bellringers/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>