...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Formación</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page staff-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/trainingTests-modal.php"); ?>
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo $utils->getRoute(); ?>personal">Personal</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                <h3 class="box-title"><i class="fa fa-book" aria-hidden="true"></i> Formación de <span id="userData"></span></h3>
                                </div>
                                <div class="pull-right">
                                    <div class="box-actions">
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm" id="newTrainingTest"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                    </div>
                                </div>
                            </div>
                            <div class="box-body">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/staff/trainingtest.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>