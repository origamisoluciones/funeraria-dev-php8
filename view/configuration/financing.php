...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Financiación</title>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Financiación</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-file-text" aria-hidden="true"></i> Gestión de financiaciones</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            <a href="#" class="btn btn-primary btn-sm" id="newFinancing" data-toggle="modal" data-target="#modal-new-financing"><i class="fa fa-plus" aria-hidden="true"></i> NUEVA FINANCIACIÓN</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
