...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Plantillas</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page templates-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/template-new-modal.php"); ?>
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-paint-brush" aria-hidden="true"></i> Gestión de Plantillas</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-template"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/template/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>