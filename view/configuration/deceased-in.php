...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Fallecido en</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed deceased-in-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/deceased-in-modal.php"); ?>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Fallecido En</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-thumb-tack" aria-hidden="true"></i> Gestión de Fallecido en</h3>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-deceasedIn"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-header">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/deceseadeIn/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>