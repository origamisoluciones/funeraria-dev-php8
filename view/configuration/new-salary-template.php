...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Nueva plantilla de salario</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>Nueva plantilla de salarios</h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Nueva plantilla de salarios</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-percent" aria-hidden="true"></i> Plantillas de salarios</h3>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <form id="formNewSalarieTemplate" class="form-horizontal">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/salaries/create.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>