...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Enterradores</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed gravediggers-page">
        <?php require_once($_SESSION['basePath'] . "view/configuration/modal/gravedigger-modal.php"); ?>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Enterradores</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                <h3 class="box-title"><i class="fa fa-user" aria-hidden="true"></i> Gestión de Enterradores</h3>
                                </div>
                                <div class="pull-right">
                                    <div class="box-actions">
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-new-gravedigger"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
                                    </div>
                                </div>
                            </div>
                            <div class="box-header">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/configuration/gravedigger/functions.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>