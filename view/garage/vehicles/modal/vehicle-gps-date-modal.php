<div class="modal fade" id="modal-gps-date-vehicles" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="goGPS" name="goGPS" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Ir</button>
            </div> 
        </div>
    </div>
</div>