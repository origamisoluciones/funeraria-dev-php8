<div class="modal fade" id="modal-edit-vehicle" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Editar <span class="bolder">Vehículo</span></h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="formEditVehicle" name="formEditVehicle">
                ...
                <div class="modal-footer">
                    ...
                    <button id="saveEditVehicle" name="saveEditVehicle" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
                </div> 
            </div>
        </div>
    </div>
