...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Taller</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed garages-page page">
        <?php require_once($_SESSION['basePath'] . "view/garage/garages/modal/garage-new-modal.php"); ?>
        <?php require_once($_SESSION['basePath'] . "view/garage/garages/modal/garage-edit-modal.php"); ?>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-car" aria-hidden="true"></i> Gestión de Talleres</h3>                   
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm btn-new" data-toggle="modal" data-target="#modal-new-garage"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO TALLER</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-header">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/garage/garages/functions.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>