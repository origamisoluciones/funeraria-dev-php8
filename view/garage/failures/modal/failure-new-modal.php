<div class="modal fade" id="modal-new-failure" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="formNewFailure" name="formNewFailure">
            ...
            <div class="modal-footer">
                ...
                <button id="saveNewFailure" name="saveNewFailure" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
            </div> 
        </div>
    </div>
</div>