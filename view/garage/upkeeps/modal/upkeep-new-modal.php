<div class="modal fade" id="modal-new-upkeep" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog" style="width: 1000px!important" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="formNewUpkeep" name="formNewUpkeep">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-xs-offset-1 col-xs-10">
                                <textarea id="notes" name="notes" class="form-control" rows="5" cols="130"></textarea>
                            </div>
                        </div>
                    </fieldset>                    
                </form>
            ...
            <div class="modal-footer">
                ...
                <button id="saveNewUpkeep" name="saveNewUpkeep" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
            </div> 
        </div>
    </div>
</div>
