...
<html>
    <head>
        ...
        <title><?php echo $utils->getCompanyName(); ?> | Error Interno</title>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Error interno</li>
                    </ol>
                </section>
                <section id="block-content" class="content">
                    <div class="error-page">
                        ...
                        <div class="error-content">
                            ...
                            <hr>
                            <h4>Por motivos técnicos no es posible en estos momentos acceder a esta parte de la plataforma.</h4>
                            <p>Puede intentarlo más tarde, volver al <a href="<?php echo $utils->getRoute(); ?>" title="Página principal de la plataforma">inicio</a> o seguir alguna de las siguientes secciones de interés:</p>
