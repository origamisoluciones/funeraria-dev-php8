...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Servicio | Tareas pendientes</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed pendingTasks-page service-control-page page">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body" id="box-body">
                                    <div class="table-responsive" id="pendingTasksSection">
                                        <table id="pendingTasks" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>          
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/serviceControl/pendingTasks/functions.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>