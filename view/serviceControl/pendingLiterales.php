...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Servicio | Literales pedientes</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed pendingLiterales-page service-control-page page">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li> C. Servicio</li>
                        <li class="active"> Literales Pendientes</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title">Literales pendientes</h3>
                                    </div>
                                </div>
                                <div class="box-body" id="box-body">
                                    <div class="table-responsive">
                                        <table id="pendingLiterales" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>          
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/serviceControl/pendingLiterales/functions.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>