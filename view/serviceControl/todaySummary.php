...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Servicios | Resumen de hoy</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed todaySummary-page service-control-page page">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li> C.Servicio</li>
                        <li class="active"> Resumen de Hoy</li>
                    </ol>
                </section>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/serviceControl/todaySummary/functions.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>