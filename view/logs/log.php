...
<html>
	...
	<body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed logs-page page">
		<div class="wrapper">
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<div class="pull-left">
										<h3 class="box-title"><i class="fa fa-file-text-o" aria-hidden="true"></i> Logs del sistema</h3>
									</div>
									...
									<div class="pull-right searchSpace" style="margin-top: 0.75em;">
										<form id="formSearchLogs" class="form-inline">
		...
		<script src="<?php echo $utils->getRoute(); ?>resources/js/logs/functions.js?v=<?= CACHE_DATE ?>"></script>
	</body>
</html>