...
<html>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed configuration-page">
                                    ...
                                    <div class="pull-left">
                                        <div class="box-actions">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" id="yearsSalaries"></select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            <button type="button" class="btn btn-primary" id="createSalaries">Crear salarios para el año actual</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="salariesMonth" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/salaries/list.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>