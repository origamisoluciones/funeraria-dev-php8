...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Albaranes | Acciones correctivas</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed order-corrective-action-page page">
        <?php require_once($_SESSION['basePath'] . "view/warehouse/deliveryNotes/modal/noAgreement.php"); ?>
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-copy" aria-hidden="true"></i> Acciones correctivas de albaranes</h3>                   
                                    </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="alert alert-info">Se muestran los proveedores que tenga algún albarán <strong>no conforme</strong></div>
                                        </div>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="table-responsive" id="deliveryNotes">
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/warehouse/deliveryNotes/correctiveActions/functions.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>