...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Albaranes</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed deliveryNotes-page page">
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-copy" aria-hidden="true"></i> Albaranes</h3>                   
                                    </div>
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            <button type="button" class="btn btn-primary btn-sm" id="genPDF"><i class="fa fa-file-pdf-o"></i> NO CONFORMIDADES</button>
                                            <label>
                                                Buscar:
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/warehouse/deliveryNotes/list/functions.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>