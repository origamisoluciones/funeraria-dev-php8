...
<html>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed orders-page page">
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title"><i class="fa fa-copy" aria-hidden="true"></i> Gestión de Pedidos</h3>                   
                                    </div>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="pull-right">
                                        <div class="box-actions">
                                            <form class="form-inline">
                                                <label for="orderAgreement">Conformidad</label>
                                                <select id="orderAgreement">
                                                    <option value="0" selected>Todos</option>
                                                    <option value="1">Conforme</option>
                                                    <option value="2">No conforme</option>
                                                    <option value="3">Conformidad cerrada</option>
                                                ...
                                                <a target="_blank" href="<?php echo $utils->getRoute(); ?>almacen/pedidos/nuevo-pedido/0" class="btn btn-primary btn-sm btn-new"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO PEDIDO</a>
                                            </form>
                                        </div>
                                    </div>
                                    <br>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/warehouse/orders/list/functions.js?v=<?= CACHE_DATE ?>"></script>
    </body>
</html>