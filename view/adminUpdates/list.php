...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Actualizaciones</title>
    ...
    <body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed pendingLiterales-page service-control-page page">
        <?php require_once($_SESSION['basePath'] . "view/adminUpdates/modal/show-update-modal.php"); ?>
        <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="pull-left">
                                        <h3 class="box-title">Histórico de actualizaciones</h3>
                                    </div>
                                </div>
                                <div class="box-body" id="box-body">
                                    <div class="table-responsive">
                                        <table id="updates" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                    </div>
                                </div>
                            </div>          
                        </div>
        ...
        <script src="<?php echo $utils->getRoute(); ?>resources/js/adminUpdates/list.js?v=<?=CACHE_DATE?>"></script>
    </body>
</html>