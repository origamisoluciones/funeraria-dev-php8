...
<html>
    <head>
        <title><?php echo $utils->getCompanyName(); ?> | Presupuesto</title>
...
<body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed budgets-page page">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="box">
                            <div class="box-header">
                                <div class="pull-left">
                                    <h3 class="box-title"><i class="fa fa-wpforms" aria-hidden="true"></i> Registro de Presupuestos</h3>                   
                                </div>
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="budgetsTable" class="table table-striped table-bordered display" width="100%" cellspacing="0"></table>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php echo $utils->getRoute(); ?>resources/js/budgets/functions.js?v=<?=CACHE_DATE?>"></script>
</body>
</html>