...
<html>
	<head>
		<title><?php echo $utils->getCompanyName(); ?> | Nuevo Expediente</title>
	...
	<body class="hold-transition skin-black sidebar-collapse sidebar-mini fixed page expedient-page new-expedient-page">
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<div class="pull-left">
										<p class="lead box-title"><i class="fa fa-list-alt" aria-hidden="true"></i> Nuevo Expediente
									</div>
								</div>
								<div class="box-body">
										...
										<form id="formNewExpedient" name="formNewExpedient" class="form-horizontal" action="<?php echo $utils->getRoute() . "core/expedients/expedient/create.php" ?>" method="POST">
											...
											<fieldset>
														...
														<div class="form-group bootstrap-timepicker timepicker">
															...
															<div class="col-xs-8">
																<div class="input-group">
																	<input type="text" size="21" class="form-control time" id="requestTime" name="requestTime" autocomplete="off">
																	<div class="input-group-addon">
												...
												<div class="row">
													...
													<div class="col-xs-3">
														<div id="divPolicy" class="form-group hide">
													...
													<div class="col-xs-3">
														<div id="divCapital" class="form-group hide">
												...
												<div class="row">
													...
													<div class="col-xs-3">
														<div class="form-group disabled">
															...
															<div class="col-xs-8">
																<input type="text" size="12" class="form-control" placeholder="<?php echo $textType; ?>" autocomplete="off" disabled>
															</div>
														</div>
													</div>
												</div>
											...
											<fieldset>
												...
												<div class="row clearfix">
													...
													<div class="col-xs-3">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<input type="email" size="25" class="form-control" id="applicantMail" name="applicantMail" autocomplete="off">
															</div>
														</div>
													</div>
												...
												<div class="row">
														...
														<div class="form-group">
															...
															<div class="col-xs-6">
																<div class="input-group" style="z-index:1000;">
																	<select size="25" id="applicantLocation" name="applicantLocation" class="form-control" disabled></select>
													...
													<div class="col-xs-3">
														<div class="form-group">
															<label class="col-xs-3 control-label toNormal">Movil</label>
															<div class="col-xs-6">
											...
											<fieldset>
													...
													<div class="row">
														<div class="col-xs-3">
															<div class="form-group">
																<label class="col-xs-3 control-label toNormal">E-mail</label>
																<div class="col-xs-6">
																	<input type="email" size="25" class="form-control" id="familyContactMail" name="familyContactMail">
																</div>
															</div>
														</div>
													</div>
													<div id="familyContactSpainFields">
														...
														<div class="col-xs-3">
															<div class="form-group">
																...
																<div class="col-xs-6">
																	<div class="input-group" style="z-index:1000;">
																		<select size="25" id="familyContactLocation" name="familyContactLocation" class="form-control" disabled></select>
																		<span class="input-group-addon"><a href="#" data-toggle="modal" data-target="#modal-new-deceasedBirthdayLocation" title="Nuevo"><i class="fa fa-plus"></i></a></span>
																	</div>
																	<span class="inputError" id="applicantLocationError"></span>
																</div>
													...
													<div class="col-xs-3">
														<div class="form-group">
															...
															<div class="col-xs-6">
																...
																<span class="inputError" id="familyContactMobileError"></span>
															</div>
														</div>
													</div>
												...
												<hr>
												<div class="pull-left">
													<legend class="toBold">Otro contacto</legend>
												</div>
												<div class="row clearfix">
													<div class="col-xs-3">
														<div class="form-group">
											...
											<fieldset>
												...
												<div class="row">
													<div class="col-xs-4 otherMaritalStatus hide">
														<div class="form-group">
															<label class="col-xs-5 control-label toNormal">Estado civil (Otros)</label>
															<div class="col-xs-6">
																<input type="text" size="25" class="form-control" id="deceasedMaritalStatusDescription" name="deceasedMaritalStatusDescription">
															</div>
														</div>
													</div>									
												</div>
												...
												<div class="row">
													...
													<div class="col-xs-4 hide">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<input type="checkbox" id="deceasedPanel" name="deceasedPanel" class="minimal deceasedPanel" autocomplete="off">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="col-xs-3">
														...
														<div class="col-xs-6">
															<div class="input-group">
																...
																<span class="input-group-addon"><a data-toggle="modal" data-target="#modal-new-cemetery" title="Nuevo"><i class="fa fa-plus"></i></a></span>
															</div>
												...
												<div class="row">
													...
													<div class="col-xs-3">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<input type="text" size="25" class="form-control" id="funeralNicheNumber" name="funeralNicheNumber" autocomplete="off">
															</div>
														</div>
													</div>
													<div class="col-xs-3">
														<div class="form-group">
															...
															<div class="col-xs-5">
																<input type="checkbox" id="funeralBusyNiche" name="funeralBusyNiche" class="minimal funeralBusyNiche">
															</div>
														</div>
													</div>
													<div class="col-xs-1">
											...
											<fieldset id="cremationData" class="fieldset hide">
												...
												<div class="row clearfix">
													...
													<div class="col-xs-4">
														<div class="form-group bootstrap-timepicker timepicker">
															...
															<div class="col-xs-6">
																<div class="input-group">
																	<input type="text" size="13" class="form-control time" id="crematoriumEntryTime" name="crematoriumEntryTime" autocomplete="off" disabled>
																	<div class="input-group-addon">
																		<i class="fa fa-clock-o"></i>
																	</div>
																</div>
												...
												<div class="row clearfix">
													<div class="col-xs-4">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<div class="input-group date">
																	<input type="text" size="20" class="form-control datepicker" id="crematoriumLeavingDate" name="crematoriumLeavingDate" autocomplete="off" disabled>
																	<div class="input-group-addon">
																		<i class="fa fa-calendar"></i>
																	</div>
																</div>
													...
													<div class="col-xs-4">
														<div class="form-group bootstrap-timepicker timepicker">
															...
															<div class="col-xs-6">
																<div class="input-group">
																	<input type="text" size="13" class="form-control time" id="crematoriumLeavingTime" name="crematoriumLeavingTime" autocomplete="off" disabled>
																	<div class="input-group-addon">
																		<i class="fa fa-clock-o"></i>
																	</div>
																</div>
												...
												<div class="row clearfix">
													...
													<div class="col-xs-4 hide">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<input type="text" size="25" class="form-control" id="trazabilityId" name="trazabilityId" autocomplete="off">
															</div>
														</div>
													</div>
												</div>
												<div class="row clearfix">
													<div class="col-xs-4" id="crematClientNewExpedient">
														<div class="form-group">
												...
												<div class="row">
													<div class="col-xs-3 hide" id="arriveFamilyTime">
														<div class="form-group bootstrap-timepicker timepicker">
												...
												<div class="row clearfix">
													...
													<div class="col-xs-3">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<input type="text" size="25" class="form-control autocompleteNif" id="authDni" name="authDni" autocomplete="off">
												...
												<div class="row clearfix">
													<div class="col-xs-3">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<div class="input-group date">
																	<input type="text" size="20" class="form-control datepicker" id="authDate" name="authDate" autocomplete="off">
																	<div class="input-group-addon">
																		<i class="fa fa-calendar"></i>
																	</div>
																</div>
													...
													<div class="col-xs-3">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<input type="text" size="25" class="form-control autocompleteNif" id="authPlace" name="authPlace" autocomplete="off">
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row clearfix">
													<div class="col-xs-4" style="z-index: 50">
														<div class="form-group">
															...
															<div class="col-xs-7">
																<div class="input-group select2-personal">
																	<select id="hearse" name="hearse" class="form-control cars-collection select2"></select>
																</div>
												...
												<div class="row clearfix">
													<div class="col-xs-3" style="z-index: 50">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<div class="input-group">
																	<select class="funeral-home-select form-control" id="funeralHome" name="funeralHome"></select>
																	<span class="input-group-addon"><a href="#" data-toggle="modal" data-target="#modal-new-funeralHome" title="Nuevo"><i class="fa fa-plus"></i></a></span>
																</div>
													...
													<div class="col-xs-2">
														<div class="form-group">
															<label class="col-xs-5 control-label toNormal">Fax</label>
															<div class="col-xs-6">
																<input type="text" size="23" class="form-control" id="funeralHomeFax" name="funeralHomeFax" autocomplete="off" disabled>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row clearfix">
													...
													<div class="col-xs-3">
														<div class="form-group">
															...
															<div class="col-xs-5">
																<input type="text" size="22" class="form-control nif autocompleteNif" id="responsibleNIF" name="responsibleNIF" autocomplete="off">
															</div>
														</div>
													</div>
												</div>
											...
											<fieldset id="moveSection" class="hide fieldset">
												...
												<div class="row clearfix">
													...
													<div class="col-xs-3">
														<div class="form-group">
															<label class="col-xs-5 control-label toNormal">Teléfono</label>
															<div class="col-xs-6">
																<input type="text" size="22" class="form-control" id="moveFuneralHomePhone" name="moveFuneralHomePhone" autocomplete="off" disabled>
															</div>
														</div>
													</div>
													<div class="col-xs-2">
												...
												<div class="row clearfix">
													...
													<div class="col-xs-4">
														<div class="form-group">
															<label class="col-xs-5 control-label toNormal">Dirección</label>
															<div class="col-xs-6">
																<input type="text" size="25" class="form-control" id="moveFuneralHomeAddress" name="moveFuneralHomeAddress" disabled>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row clearfix">								
													...
													<div class="col-xs-4">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<div class="input-group">
																	<select id="moveCollection" name="moveCollection" class="form-control" disabled></select>
																	<span class="input-group-addon"><a href="#" data-toggle="modal" data-target="#modal-new-deceasedBirthdayLocation" title="Nuevo"><i class="fa fa-plus"></i></a></span>
																</div>
												...
												<div class="row-clearfix">
													...
													<div class="col-xs-4">
														<div class="form-group">
															...
															<div class="col-xs-6">
																<select id="moveDestination" name="moveDestination" class="form-control" disabled></select>
																<span class="inputError" id="applicantLocationError"></span>
															</div>
														</div>
													</div>
												...
												<div class="row clearfix">
													...
													<div class="row clearfix flightSection hide">
														<div class="col-xs-4">
															<div class="form-group">
				...
				<div class="row">
					<div class="col-xs-12">
						<ul id="expedient-tabs" class="nav nav-tabs" role="tablist">
							...
							<li role="presentation" class="disabled"><a href="#">ESQUELA</a></li>
							<li role="presentation" class="disabled"><a href="#">C.SERVICIO</a></li>
							<?php if($_SESSION['tellmebye'] == '1'){ ?>
								<li role="presentation" class="disabled"><a href="#">TELLMEBYE</a></li>
							<?php } ?>
							<li role="presentation" class="disabled"><a href="#">DOCUMENTACIÓN</a></li>
							<li role="presentation" class="disabled"><a href="#">DOCUMENTACIÓN PERSONALIZADA</a></li>
		...
		<script src="<?php echo $utils->getRoute(); ?>resources/js/expedient/expedient-new/functions.js?v=<?= CACHE_DATE ?>"></script>
	</body>
</html>