...
<div class="modal fade modalSave" id="modal-save" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="overflow: auto;">
                <p>El documento se está guardando. En breves, podrás continuar con la edición</p>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal-expedient-info" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><span class="bolder">Atajos</span></h4>
            </div>
            <div class="modal-body" style="overflow: auto;">
                ...
                <fieldset>
                    <legend>
                        <span class="label label-primary">Orden de Trabajo</span>
                    </legend>
                    <div>
                        <ul>
                            <li><span class="expediente-copy-alias" alias="#268#"><strong>Fecha Embalsamamiento</strong>: #268#</span></li>
                            <li><span class="expediente-copy-alias" alias="#269#"><strong>Hora Embalsamamiento</strong>: #269#</span></li>
                            <li><span class="expediente-copy-alias" alias="#270#"><strong>Fecha C. Transitoria</strong>: #270#</span></li>
                            <li><span class="expediente-copy-alias" alias="#271#"><strong>Hora C. Transitoria</strong>: #271#</span></li>
                            <li><span class="expediente-copy-alias" alias="#272#"><strong>Ropa</strong>: #272#</span></li>
                            <li><span class="expediente-copy-alias" alias="#273#"><strong>Tanatoestética</strong>: #273#</span></li>
                            <li><span class="expediente-copy-alias" alias="#274#"><strong>Nombre arca</strong>: #274#</span></li>
                            <li><span class="expediente-copy-alias" alias="#275#"><strong>Rosario</strong>: #275#</span></li>
                            <li><span class="expediente-copy-alias" alias="#276#"><strong>Cruz</strong>: #276#</span></li>
                            <li><span class="expediente-copy-alias" alias="#277#"><strong>Cristo</strong>: #277#</span></li>
                            <li><span class="expediente-copy-alias" alias="#278#"><strong>Prensa</strong>: #278#</span></li>
                            <li><span class="expediente-copy-alias" alias="#279#"><strong>Cruz de Hierro</strong>: #279#</span></li>
                        </ul>
                    </div>
                </fieldset>
            </div>
