<div class="modal fade" id="modal-edit-cleaning" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="formEditCleaning" name="formEditCleaning">
                    <input type="hidden" id="eventID" name="eventID" value="">
                    <div class="form-group">
                        <label for="startDate" class="col-xs-3 control-label">Fecha de inicio</label>
                        <div class="col-xs-9">
                            <div class="input-group date">
                                <input type="text" size="10" class="form-control datepicker" id="startDate" name="startDate">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <div class="input-group date">
                                <input type="text" size="10" class="form-control datepicker" id="endDate" name="endDate">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </div>
                    ...
                    <div class="form-group">
                        <label for="cleaningUser" class="col-xs-3 control-label">Usuario</label>
                        <div class="col-xs-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" size="21" class="form-control" id="name" name="name">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="closeDoneCleaning" type="button" class="btn btn-warning"><i class="fa fa-check-circle" aria-hidden="true"></i> Realizar y finalizar</button>
                        <button id="closeCleaning" type="button" class="btn btn-success"><i class="fa fa-check-circle" aria-hidden="true"></i> Realizado</button>
                        <button id="deleteCleaning" type="button" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Eliminar</button>
                        <button id="saveEditCleaning" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
                    </div>
                </form>
            </div>
        </div>
