<div class="modal fade" id="modal-edit-event-garage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
                ...
                <form class="form-horizontal" id="formEditData" name="formEditData">
                    ...
                    <div class="form-group hide">
                        <div class="col-xs-offset-3 col-xs-8">
                            <div class="checkbox">
                                <label>
                                    <input id="reminder" name="reminder" class="minimal" type="checkbox">
                                    Recordatorio
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="saveEditEventGarage" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
                    </div>
                </form>
            </div>
        </div>
