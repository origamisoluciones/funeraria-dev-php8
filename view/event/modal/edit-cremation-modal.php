<div class="modal fade" id="modal-edit-cremation" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="formEditCremation" name="formEditCremation">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-5">
                                <label for="crematoriumTechnical" class="col-xs-5 control-label labelsCremat">Técnico cremación</label>
                                <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            <div class="col-xs-3">
                                <label for="startDate" class="col-xs-5 control-label labelsCremat">Fecha de inicio</label>
                                <div class="col-xs-7">
                            ...
                            <div class="col-xs-3">
                                <label for="endDate" class="col-xs-4 control-label labelsCremat">Fecha de fin</label>
                                <div class="col-xs-8">
                                    <div class="input-group date">
                            ...
                            <div class="col-xs-3">
                                <label for="endTime" class="col-xs-4 control-label labelsCremat">Hora de fin</label>
                                <div class="col-xs-8">
                                    <div class="input-group bootstrap-timepicker timepicker">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-3">
                                <label for="user" class="col-xs-5 control-label labelsCremat">Usuario</label>
                                <div class="col-xs-7">
                                    <input type="text" size="16" class="form-control" id="user" name="user" disabled>
                                </div>
                            </div>
                            <div class="col-xs-3">
                    ...
                    <fieldset>
                        ...
                        <div class="row form-group">
                            <div class="col-xs-4" style="z-index: 800 !important;">
                                <label for="client" class="col-xs-6 control-label labelsCremat">Nombre</label>
                                <div class="col-xs-6">
                                    <select class="form-control select2 client" id="client" name="client"></select>
                                </div>
                            </div>
                            <div class="col-xs-4" style="z-index: 700 !important;">
                                <label for="cif" class="col-xs-7 control-label labelsCremat">CIF</label>
                                <div class="col-xs-5">
                                    <input type="text" size="10" class="form-control" id="cif" name="cif" disabled>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <label for="phone" class="col-xs-6 control-label labelsCremat">Teléfono</label>
                                <div class="col-xs-6">
                        ...
                        <div class="row form-group">
                            <div class="col-xs-4">
                                <label for="contactPerson" class="col-xs-6 control-label labelsCremat">Persona de contacto</label>
                                <div class="col-xs-6">
                                    <input type="text" size="24" class="form-control" id="contactPerson" name="contactPerson">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <label for="crematoriumContactPhonePerson" class="col-xs-7 control-label labelsCremat">Teléfono contacto</label>
                                <div class="col-xs-5">
                                    <input type="text" size="10" class="form-control" id="crematoriumContactPhonePerson" name="crematoriumContactPhonePerson">
                                </div>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-3">
                                <label for="number" class="col-xs-5 control-label labelsCremat">Nº expediente</label>
                                <div class="col-xs-7">
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-xs-3" style="z-index: 700 !important;">
                                <div class="form-group">
                                    <label class="col-xs-8 control-label"><input type="checkbox" class="" id="ecologicCoffin" name="ecologicCoffin" value="ecologicCoffin" style="margin-right: 5px;"> Féretro ecológico</label>
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="saveEditCremation" type="button" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
                    </div>
                </form>
            </div>
        </div>
